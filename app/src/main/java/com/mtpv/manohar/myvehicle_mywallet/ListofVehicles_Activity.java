...
public class ListofVehicles_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listvehicles);
            ...
            public void onClick(View v) {
                {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(ListofVehicles_Activity.this,
